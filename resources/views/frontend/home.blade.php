                    ...
                    <div class="nav-main">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link @if ($i == 1){{ 'active' }} @endif"
                                    data-toggle="tab" href="#{{ $categoryName }}" role="tab">{{ $category->name }}</a>
                            </li>
                            @php $i++; @endphp
                            @endforeach
            ...
            <div class="col-12">
                <div class="owl-carousel popular-slider">
                    ...
                    <div class="single-product addtocard-item">
                        <div class="product-img">
                            ...
                            <div class="button-head">
                                <div class="product-action">
                                    <a data-toggle="modal" class="modal-view"
                                        data-target="#exampleModal{{$allitem->id}}" title="Quick View" href="#"
                                        data-id="{{ $allitem->id }}" data-name="{{ $allitem->name }}"
                                        data-price="{{ $allitem->price }}" data-discount="{{ $allitem->discount }}"
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModal{{$allitem->id}}" tabindex="-1" role="dialog">
                                                    ...
                                                    <div class="quantity">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="quant[1]"
                                                                class="input-number input-qty" data-min="1"
                ...
                <div class="single-list addtocard-item">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 no-padding">
                            <div class="content">
                                <h4 class="title"><a href="{{ route('frontend.detail', $discount_item->id) }}">{{
                                        $discount_item->name }}</a>
                                </h4>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-list addtocard-item">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 no-padding">
                            <div class="content">
                                <h5 class="title"><a href="{{ route('frontend.detail', $allitem->id) }}">
                                        {{ $allitem->name }} </a></h5>
                                <p class="price with-discount">
                                    @if ($allitem->discount)
                                    ${{ $allitem->discount }}
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-list addtocard-item">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="list-image overlay">
                                ...
                                <a title="Add to cart" class="addtocartBtn buy text-decoration-none"
                                    ...
                                    data-photo="<?= $latest_item->photo ?>" data-codeno="<?= $latest_item->codeno ?>"
                        ...
                        <div class="col-lg-6 col-md-6 col-12 no-padding">
                            <div class="content">
                                <h5 class="title"><a href="{{ route('frontend.detail', $latest_item->id) }}">
