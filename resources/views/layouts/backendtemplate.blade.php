...
<head>
    ...
    <link href="{{ asset('backend_assets/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet"
        type="text/css">
    <link
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseData" class="collapse {{ Request::is('data-management/*') ? 'show' : '' }}"
            ...
            <li class="nav-item">
                ...
                <div id="collapseUser" class="collapse {{ Request::is('user-management/*') ? 'show' : '' }}"
            ...
            <li class="nav-item">
                ...
                <div id="collapseOrders" class="collapse {{ Request::is('order-management/*') ? 'show' : '' }}"
                    aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Utilities:</h6>
